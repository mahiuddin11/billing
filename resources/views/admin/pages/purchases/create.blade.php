                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel16">Attribute</h4>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.close_model', function() {
                $('#custome_column_list').find('tr').removeClass('d-none');
                $('#custome_column_list').find('tr').addClass('d-none');
            })

            $(document).on('click', '.open_model', function() {
                let productId = $(this).closest('tr').find('.add_quantity').val();
                $('.productid' + Number(productId)).removeClass('d-none');
            })
