                    ...
                    <div class="basic-form">
                        <form action="{{ $update_url ?? '#' }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="Email">Email Address <span
                                                        style="color: #f90000;">✱</span></label>
                                                <input class="form-control mb-3" value="{{ $editinfo->email }}"
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="MobileNumber">Mobile No. <span
                                                        style="color: #f90000;">✱</span></label>
                                                <input class="form-control mb-3" value="{{ $editinfo->mobile }}"
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control mb-3" value="{{ $editinfo->phone }}"
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="Address">Client Code <span
                                                        style="color: #f90000;">✱</span></label>
                                                <input class="form-control mb-3" readonly
                                                    value="{{ $editinfo->reseller_code }}" name="reseller_code"
                                                    type="text">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="s">Client Prefix <span style="color: #f90000;">✱</span>
                                                    &nbsp;</label>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control mb-3" name="set_prefix_mikrotikuser">
                                                    ...
                                                    <option
                                                        {{ $editinfo->set_prefix_mikrotikuser == 'yes' ? 'selected' : '' }}
                                                        value="yes">Yes, I Want</option>
                                                    <option
                                                        {{ $editinfo->set_prefix_mikrotikuser == 'no' ? 'selected' : '' }}
                                                        value="no">No, I
                                                        Don't </option>
                                                </select>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="Address">Client Type <span style="color: #f90000;">✱</span>
                                                </label>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="file">Client Logo</label><br>
                                                <input class="form-control" name="reseller_logo" type="file">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="file">Expire Date</label><br>
                                                <input class="form-control" value="{{ $editinfo->expire_date }}"
                                                    name="expire_date" type="number">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="info-head">
                                    <h3>
                                        <i class="fa fa-briefcase" aria-hidden="true"></i> Business &amp; Login
                                        Information
                                    </h3>
                                </div>
                                <div class="info-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="ResellerName">Client <b>/</b> Business Name <span
                                                        style="color: #f90000;">✱</span></label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control mb-3" name="tariff_id">
                                                    ...
                                                    @foreach ($Mactariffs as $Mactariff)
                                                        <option value="{{ $Mactariff->id }}"
                                                            {{ $editinfo->tariff_id == $Mactariff->id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control mb-3" name="user_roll">
                                                    ...
                                                    @foreach ($userRolls as $userRoll)
                                                        <option
                                                            {{ $editinfo->getUser->roll_id == $userRoll->id ? 'selected' : '' }}
                                                            value="{{ $userRoll->id }}">{{ $userRoll->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
