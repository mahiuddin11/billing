                        ...
                        <form action="{{ $store_url ?? '#' }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-1">
                                    ...
                                    <select name="customer_id" class="form-control getAmount" id="">
                                ...
                                <div class="col-md-4 mb-1 ">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option {{ old('status') == 'unpaid' ? 'selected' : '' }} value="unpaid">Unpaid
                                        </option>
                                        <option {{ old('status') == 'partial' ? 'selected' : '' }} value="partial">Due
                                        </option>
                                    </select>
                                </div>
...
@section('scripts')
    <script>
        $(document).on('change', '.getAmount', function() {
            let id = $(this).val();
