                        ...
                        <form action="{{ $store_url ?? '#' }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                    ...
                                    <select class="form-control select2" onchange="checkAccountSelector()"
                                        ...
                                        @foreach ($accounts as $key => $value)
                                            <option value="{{ $value->id }}">
                                                {{ $value->head_code . ' - ' . $value->account_name }}</option>
                                        @endforeach
                                    </select>
                                    </select>
                                ...
                                <div class="col-md-4 mb-1">
                                    ...
                                    <input type="text" name="amount" onkeyup="cehckBalance(this.value)"
                                ...
                                <div class="col-md-4 mb-1">
                                    ...
                                    <textarea name="note" rows="1" class="form-control" id="validationCustom02" placeholder="Note"
