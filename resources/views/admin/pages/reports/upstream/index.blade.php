        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Upstream</h4>
                ...
                <div class="card-datatable table-responsive">
                    ...
                    <div class="treeview w-20 border">
                        <ul class="mb-1 pl-3 pb-2">
                            ...
                            <form action="{{ route('reports.upstream') }}" method="POST" class="mt-3">
                                @csrf
                                <section>
                            ...
                            <div class="table-responsive mt-2">
                                <table width="100%" class="table table-bordered table-stripped print-font-size"
                                    ...
                                    <tbody>
                                        ...
                                        @if (isset($upstream))
                                            @foreach ($upstream as $monthl)
                                                @if ($monthl->account_id !== 13)
                                                    @php($count++)
                                                    <tr class="table_data">
                                                        <td align="right">
                                                            <strong>{{ $count }}</strong>
                                                        ...
                                                        <td>
                                                            {{ $monthl->providerCustomer->company_name }}
                                                        </td>
                                                        <td align="right">
                                                        ...
                                                        <td align="right">
                                                            <strong>{{ $monthl->remark }}
                                                                {{ empty($monthl->credit) ? 'Month: ' . ($monthl->upstreamBill->billing_month ?? "") : '' }}</strong>
                                                        </td>
                                                        <?php
