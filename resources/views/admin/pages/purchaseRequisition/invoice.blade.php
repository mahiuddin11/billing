                        ...
                        <div class="row">
                            ...
                            <table class="table table-bordered table-hover" id="show_item">
                                ...
                                <tbody>
                                    ...
                                    <tr class="new_item" {{$value->id}}>
                                        <td style="padding-left:15px;">{{$value->productCategory->name}}
                                            <input type="hidden" class="add_quantity" name="catName[]"
                                                value="{{$value->productCategory->id}}">
                                        </td>
                                        <td style="padding-left:15px;">{{$value->product->name}}<input type="hidden"
                                                class="add_quantity" name="proName[]" value="{{$value->product->id}}">
                                        </td>
                                        <td class="text-right"><input type="number"
                                                class="form-control  qty reset_qty ttlqty" name="qty[]"
                                                value="{{$value->quantity}}"></td>
                                        <td class="text-right"><input type="number" readonly
                                                class="form-control unitprice reset_unitprice ttlunitprice"
                                                name="unitprice[]" value="{{$value->unit_price}}">
                                        </td>
                                        <td class="text-right">
                                            <input type="text" readonly class="form-control total checktotal"
                                                name="total[]" value="{{$value->total_price}}">
                                        </td>
                                        <!-- <td>
                                ...
                                <table class="table table-bordered table-hover" id="cart_output">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right">
                                            ...
                                            placeholder="Ex:5">
                                            <div class="text-danger payment_amount_error"></div>
                                            @error('paid_amount')
                                            <span class=" error text-red text-bold">{{ $message }}</span>
                                            @enderror
                                        </th>
