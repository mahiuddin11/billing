                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select name="arp" class="select2 form-control">
                                        <option {{ $editinfo->arp == 'disabled' ? 'selected' : '' }} value="disabled">
                                            disabled
                                        </option>
                                        ...
                                        <option {{ $editinfo->arp == 'local-proxy-arp' ? 'selected' : '' }}
                                            ...
                                            proxy arp</option>
                                        <option {{ $editinfo->arp == 'proxy-arp' ? 'selected' : '' }} value="proxy-arp">
                                            proxy
                                            arp</option>

                                        <option {{ $editinfo->arp == 'reply-only' ? 'selected' : '' }} value="reply-only">
                                            reply only</option>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-1">
                                    <label for="">Vlan Id <span class="text-danger">*</span></label>
                                    <input type="text" value="{{ $editinfo->vlan_id }}" class="form-control"
                                        name="vlan_id">
                                </div>
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select name="server_id" class="select2 form-control">
                                        ...
                                        @foreach ($servers as $value)
                                            <option {{ $editinfo->server_id == $value->id ? 'selected' : '' }}
                                                value="{{ $value->id }}">
                                                {{ $value->user_name }}({{ $value->server_ip }})</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select name="use_service_tag" class="select2 form-control">
                                        <option disabled selected>Select Interface</option>
                                        <option {{ $editinfo->use_service_tag == 'true' ? 'selected' : '' }}
                                            value="true">
                                            Yes
                                        </option>
                                        <option {{ $editinfo->use_service_tag == 'false' ? 'selected' : '' }}
                                            value="false">
                                            No
                                        </option>
                                    </select>
