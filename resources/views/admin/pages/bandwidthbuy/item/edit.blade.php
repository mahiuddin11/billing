                        ...
                        <form action="{{ $update_url ?? '#' }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-1">
                                    ...
                                    <input type="text" value="{{ $editinfo->name ?? '' }}"
                                        class="form-control input-rounded" name="name">
                                </div>

                                <div class="col-md-4 mb-1">
                                    <label for="">Unit </label>
                                    <input type="text" value="{{ $editinfo->unit ?? '' }}"
                                        class="form-control input-rounded" name="unit">
                                </div>

                                <div class="col-md-4 mb-1">
                                    <label for="">Vat% </label>
                                    <input type="text" value="{{ $editinfo->vat ?? '' }}"
                                        class="form-control input-rounded" name="vat">
                                </div>
                                ...
                                {{-- <div class="col-md-4 mb-1">
                                    ...
                                    <select name="status" class="form-control" id="">
                                        ...
                                        <option {{ $editinfo->status == 'inactive' ? 'selected' : '' }} value="inactive">
                                            InActive</option>
                                    </select>
                                </div> --}}
