                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="phone"
                                                    value="{{ old('phone') ?? ($editinfo->phone ?? '') }}"
                                                    placeholder="Phone">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="code"
                                                    value="{{ old('code') ?? ($editinfo->code ?? '') }}" placeholder="Code">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded"
                                                    name="contact_person"
                                                    value="{{ old('contact_person') ?? ($editinfo->contact_person ?? '') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="mobile"
                                                    value="{{ old('mobile') ?? ($editinfo->mobile ?? '') }}"
                                                    placeholder="Mobile">
                                            </div>
                                        </div>
                                        {{--
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="reference_by"
                                                    value="{{ old('reference_by') ?? ($editinfo->reference_by ?? '') }}"
                                                    placeholder="reference_by">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                <label class="text-uppercase">Address <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control input-rounded" name="address"
                                                    value="{{ old('address') ?? ($editinfo->address ?? '') }}"
                                                    placeholder="address">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="remarks"
                                                    value="{{ old('remarks') ?? ($editinfo->remarks ?? '') }}"
                                                    placeholder="remarks">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                <label class="text-uppercase">Facebook <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control input-rounded" name="facebook"
                                                    value="{{ old('facebook') ?? ($editinfo->facebook ?? '') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="skypeid"
                                                    value="{{ old('skypeid') ?? ($editinfo->skypeid ?? '') }}"
                                                    placeholder="skypeid">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="website"
                                                    value="{{ old('website') ?? ($editinfo->website ?? '') }}"
                                                    placeholder="website">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="nttn_info"
                                                    value="{{ old('nttn_info') ?? ($editinfo->nttn_info ?? '') }}"
                                                    placeholder="nttn_info">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="vlan_info"
                                                    value="{{ old('vlan_info') ?? ($editinfo->vlan_info ?? '') }}"
                                                    placeholder="vlan_info">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="vlan_id"
                                                    value="{{ old('vlan_id') ?? ($editinfo->vlan_id ?? '') }}"
                                                    placeholder="vlan_id">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded"
                                                    name="scr_or_link_id"
                                                    value="{{ old('scr_or_link_id') ?? ($editinfo->scr_or_link_id ?? '') }}"
                                                    placeholder="scr_or_link_id">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                <label class="text-uppercase">Activition date</label>
                                                <input type="text" class="form-control input-rounded"
                                                    name="activition_date"
                                                    value="{{ old('activition_date') ?? ($editinfo->activition_date ?? '') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="ipaddress"
                                                    value="{{ old('ipaddress') ?? ($editinfo->ipaddress ?? '') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="pop_name"
                                                    value="{{ old('pop_name') ?? ($editinfo->pop_name ?? '') }}"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                <label class="text-uppercase">Password <span
                                                        class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-1">
                                                <label class="text-uppercase">Confirm Password <span
                                                        class="text-danger">*</span></label>
