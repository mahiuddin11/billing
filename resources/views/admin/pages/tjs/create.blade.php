                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <select class="form-control" name="tj_id" id="tj_id">
                                    <option selected disabled>Select Tj Box</option>
                                    @foreach($tjbox as $key=>$value)
                                    <option value="{{$value->id}}">{{$value->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 mb-1">
                                <label>Core</label>
                                <input type="number" class="form-control input-rounded" id="core"
                                    value="{{old('core')}}" name="core" placeholder="Ex:16">
                            </div>
