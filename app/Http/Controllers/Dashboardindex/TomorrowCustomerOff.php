...
class TomorrowCustomerOff extends Controller
{
     ...
     * String property
     */
    protected $routeName =  'tomorrow_line_off';
    ...
    {
        // $tomorrow_line_off = Transaction::where('company_id', auth()->user()->company_id)->where('type', 12)->where('exp_date', Carbon::tomorrow())->pluck('local_id');
        $tomorrow_line_off = Customer::where('company_id', auth()->user()->company_id)->where('exp_date', Carbon::tomorrow()->format('Y-m-d'));
